...
Plant operators live in this. They see their forecasts, manage scheduling, send revisions (CT/ST schedules to SLDC), and pull reports. I rebuilt the old React dashboard as a Next.js app in TypeScript, mostly because the old one was slow and operators were copy-pasting numbers into Excel to work around it.
