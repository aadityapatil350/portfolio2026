...
tech: ["Next.js", "TimescaleDB", "PostgreSQL", "WebSockets", "MQTT", "OPC-UA", "Docker", "Azure"]
status: "Production"
---
...
- **TimescaleDB / PostgreSQL** — Time-series optimized storage for telemetry data with hypertable partitioning
